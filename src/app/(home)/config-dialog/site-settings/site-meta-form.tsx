...
export function SiteMetaForm({ formData, setFormData }: SiteMetaFormProps) {
	return (
		<div>
			<SectionHeader>SITE META</SectionHeader>
			<div className='space-y-4'>
				<div className='grid grid-cols-2 gap-4'>
					<div>
						<label className='mb-2 block text-[10px] tracking-[0.2em] text-[#555]'>站点标题</label>
						<input
							type='text'
					...
					<div>
						<label className='mb-2 block text-[10px] tracking-[0.2em] text-[#555]'>用户名</label>
						<input
							type='text'
				...
				<div>
					<label className='mb-2 block text-[10px] tracking-[0.2em] text-[#555]'>站点描述</label>
					<textarea
