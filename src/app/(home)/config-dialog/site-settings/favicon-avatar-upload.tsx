	...
	return (
		<div>
			...
			<div className='grid grid-cols-2 gap-4'>
				<div>
					<label className='mb-2 block text-[10px] tracking-[0.2em] text-[#555]'>Favicon</label>
					<input ref={faviconInputRef} type='file' accept='image/*' className='hidden' onChange={handleFaviconFileSelect} />
					<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-lg border bg-white/5' style={{ borderColor: 'var(--color-border)' }}>
				...
				<div>
					<label className='mb-2 block text-[10px] tracking-[0.2em] text-[#555]'>Avatar</label>
					<input ref={avatarInputRef} type='file' accept='image/*' className='hidden' onChange={handleAvatarFileSelect} />
					<div className='group relative h-20 w-20 cursor-pointer overflow-hidden rounded-full border bg-white/5' style={{ borderColor: 'var(--color-border)' }}>
